...
class ResNet3d_stn(nn.Module):
    ...
    def __init__(self,
        ...
        self.out_indices = out_indices  #3
        assert max(out_indices) < num_stages
        self.spatial_strides = spatial_strides  #(1, 2, 2, 2)
        ...
        self.res_layers = []
        for i, num_blocks in enumerate(self.stage_blocks):  #stage_blocks=(Bottleneck3d, (3, 4, 23, 3))
...
@BACKBONES.register_module()
class ResNet3dLayer_stn(nn.Module):
    """ResNet 3d Layer.
...
if mmdet_imported:
    MMDET_SHARED_HEADS.register_module()(ResNet3dLayer_stn)
