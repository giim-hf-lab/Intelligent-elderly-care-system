...
from .resnet3d_stn import ResNet3d_stn
...
class ResNet3dPathway(ResNet3d_stn):
...
class ResNet3dSlowFast_stn(nn.Module):
    """Slowfast backbone.
...
if mmdet_imported:
    MMDET_BACKBONES.register_module()(ResNet3dSlowFast_stn)
