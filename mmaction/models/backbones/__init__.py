...
from .resnet3d_stn import ResNet3d_stn, ResNet3dLayer_stn
from .resnet3d_slowfast_stn import ResNet3dSlowFast_stn
...
__all__ = [
    ...
    'ResNet3d_stn','ResNet3dLayer_stn','ResNet3dSlowFast_stn'
]
